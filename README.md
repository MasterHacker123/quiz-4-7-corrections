...
function classScheduling() {
  ...
  let course = prompt("Please enter a course being taught in the school:");
  let maxCapacity = prompt("Please enter the maximum capacity of a single section of the course:");
  let numberOfSections = Math.ceil(numberOfStudents / maxCapacity);
